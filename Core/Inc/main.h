...
/* Private defines -----------------------------------------------------------*/
#define SEN_LED_R_Pin LL_GPIO_PIN_14
#define SEN_LED_R_GPIO_Port GPIOC
#define SEN_LED_L_Pin LL_GPIO_PIN_15
#define SEN_LED_L_GPIO_Port GPIOC
#define MOTOR_L_IN1_Pin LL_GPIO_PIN_2
#define MOTOR_L_IN1_GPIO_Port GPIOA
#define MOTOR_L_IN2_Pin LL_GPIO_PIN_3
#define MOTOR_L_IN2_GPIO_Port GPIOA
#define SEN_LED_FL_Pin LL_GPIO_PIN_5
...
#define IFR_LED2_GPIO_Port GPIOA
#define FUN_Pin LL_GPIO_PIN_11
#define FUN_GPIO_Port GPIOA
#define IFR_LED3_Pin LL_GPIO_PIN_12
#define IFR_LED3_GPIO_Port GPIOA
#define SEN_LED_FR_Pin LL_GPIO_PIN_15
#define SEN_LED_FR_GPIO_Port GPIOA
